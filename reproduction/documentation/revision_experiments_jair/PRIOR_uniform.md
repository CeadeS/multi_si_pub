# Prior Specification: `uniform`

All probability/sensitivity statements are conditional on this declared prior.

| Parameter | Range | Family | Notes |
|---|---:|---|---|
| β_D | [0.05, 1.0] | uniform | defection temptation |
| β_κ | [0.5, 3.0] | uniform | conflict / deterrence |
| β_α | [0.3, 0.9] | uniform | coordination / signal value |
| β_Ω | [0.05, 0.3] | uniform | oversight / membership value |
| β_ℓ | [0.1, 0.5] | uniform | removal / outside option |
...
| q | [0.0, 0.3] | uniform | detection-failure probability (external-action monitoring) |
